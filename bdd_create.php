...
$table_users = "CREATE TABLE `e_boutique`.`users` (`id` INT NOT NULL AUTO_INCREMENT , `firstname` VARCHAR(50) NOT NULL , `lastname` VARCHAR(50) NOT NULL , `role` VARCHAR(15) NOT NULL DEFAULT 'utilisateur' , `img_profil_path` VARCHAR(255) NOT NULL DEFAULT '/media/users/default.jpg' , `email` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;";
